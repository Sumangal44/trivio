export const questionsData = {
  html: [
    ...
    {
      question:
        '4) Which attribute specifies an alternative text for an image?',
  ...
  cli: [
    ...
    {
      question:
        '2) What display technology was used in early terminals with green text?',
      answers: [
  ...
  js: [
    {
      question:
        '1) Which keyword is used to declare a constant variable in JavaScript?',
