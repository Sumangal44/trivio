...
try {
  ...
  // FORCE_RELEASE=true -> remove the lowest conflicting tag (the smallest > current)
  ...
  try {
    ...
    // continue anyway - standard-version may still fail if remote tag blocks creation
  }
